...
(function() {
  ...
  const translations = {
    zh: {
      ...
      'aprsHowto': '① 手台正常开机 → ② 点「连接手台」→ ③ 点选台站（或点「推送到手台」）→ 机身打开 APRS 页（需后续固件支持）',
      'aprsConnect': '连接手台',
      'aprsDisconnect': '断开手台',
      'aprsPush': '推送到手台',
      'aprsSearchBtn': '查询',
    ...
    en: {
      ...
      'aprsHowto': '① Power on the radio normally → ② Click “Connect radio” → ③ Select a station (or “Push to radio”) → the radio opens the APRS page (firmware support coming later)',
