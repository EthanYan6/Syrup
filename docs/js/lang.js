 ...
 *
 * The Syrup name, logo, and official project identity
...
(function() {
  ...
  const translations = {
    zh: {
      // Page title and meta
      'pageTitle': '小甜水刷机网站 · Syrup',
      'brandTagline': 'Syrup · Quansheng UV-K1 / K5V3',
      'tabCalibCheck': '校验校准',
      'stepCalibCheck': '校验校准',
      ...
      'douyin': '抖音',
      'douyinName': '小闫连不上',
      'douyinChipTitle': '抖音 · 小闫连不上',
      'bili': 'B站',
      'biliName': '小闫连不上',
      'biliChipTitle': '哔哩哔哩 · 小闫连不上',
      'redbook': '小红书',
      'redbookName': '小闫同学',
      'redbookChipTitle': '小红书 · 小闫同学',
      'wechatVideo': '微信视频号',
      'wechatVideoName': '小闫连不上',
      'wechatVideoChipTitle': '微信视频号 · 小闫连不上',
      'fmoScreen': 'FMO副屏',
      'travelJournal': '旅行手账',
      'drivingHud': '自驾游大屏',
      'clickView': '点击查看',
      ...
      'step4': '刷字库',
      'step4Tooltip': '开机状态下刷入中文字库 cn_font.bin（SPI 0x024000，6766 字）。字库有更新时需重新刷入。',
      'step5': '恢复校准',
      ...
      'tabBootSound': '开机音效',
      'tabMaterials': '素材下载',
      'materialsHint': '下载后可到「开机图片」「开机音效」页上传到对讲机。图片会自动转成 128×64 单色；音频会转成约 5 秒 PCM。',
      'materialsImagesTitle': '开机图片',
      'materialsSoundsTitle': '开机音效',
      'materialsDownload': '下载',
      'tabBackupcfg': '备份配置',
      'tabRestorecfg': '恢复配置',
      'tabToolbox': '应急工具箱',
      ...
      // Font tab (CN font @ 0x024000)
      'fontDesc1': '将中文字库刷入 SPI Flash（0x024000），支持 6766 个中文字符。',
      'fontWarning1': '⚠️ 需要支持中文显示的固件才需刷字库。',
      'fontWarning2': '⚠️ 请先正常开机进入使用界面后再连接 USB 刷字库（与备份校准相同，无需 BOOT 模式）。',
      'fontFile': '字库文件 (.bin)',
      'fontDownloadHint': '「远程获取」将加载本站默认字库 cn_font.bin（约 200 KB，与叮咚鸡同源格式）。',
      'flashFont': '刷入字库',
      'selectLocalFont': '选择本地字库',
      ...
      'calibCheckSyrup': 'Syrup 校准地址(0xB000)',
      ...
      // Aircraft radar
      'radarStatusIdle': '进入本页后将请求定位并扫描附近飞机',
      'radarStatusLocating': '正在获取位置…',
      'radarStatusFetching': '正在扫描附近飞机…',
      'radarStatusOk': '扫描中 · 发现 {n} 架',
      'radarStatusEmpty': '附近暂无 ADS-B 目标',
      'radarStatusError': '获取飞机数据失败，将自动重试',
      'radarStatusNeedProxy': '无法获取附近飞机数据',
      'radarStatusRateLimited': '接口限流，稍后自动重试',
      'radarStatusPaused': '已暂停刷新',
      'radarStatusGeoDenied': '需要允许位置权限才能探测附近飞机',
      'radarStatusNoGeo': '当前浏览器不支持定位',
      'radarLat': '纬度',
      'radarLon': '经度',
      'radarQuery': '查询',
      'radarRadius': '范围 (km)',
      'radarUseMyLocation': '重置定位',
      'radarLatPlaceholder': '39.9042',
      'radarLonPlaceholder': '116.4074',
      'radarStatusBadCoords': '请输入有效的纬度和经度',
      'radarCoverageHint': '目前国内只能查到国外、港澳台地区、广州周边、合肥到南京周边、成都至绵阳周边、北京至石家庄至邯郸至天津范围及周边、西安周边300km，其它用户可手动修改经纬度，获取地图。',
      'radarRefresh': '刷新',
      'radarPause': '暂停',
      'radarResume': '继续',
      'radarCount': '飞机：{n}',
      'radarCountZero': '飞机：0',
      'radarUpdated': '上次刷新：{time}',
      'radarUpdatedNever': '上次刷新：—',
      'radarDetailTitle': '飞机信息',
      'radarDetailEmpty': '点击雷达上的目标查看详情',
      'radarCallsign': '呼号',
      'radarFlight': '航班',
      'radarAirline': '航司',
      'radarIcao': 'ICAO',
      ...
      'radarDistance': '距离',
      'radarBearing': '方位',
      'radarAirlineUnknown': '未知航司',
      'radarFlightUnknown': '—',
      'radarFootnote': '数据来源：<a href="https://adsb.fi/" target="_blank" rel="noopener noreferrer">adsb.fi</a>（ADS-B）。',
      'radarHowto': '① 手台正常开机 → ② 点「连接手台」→ ③ 点选飞机（或点「推送到手台」）→ 机身打开飞机页并 AM 收听',
      'radarConnect': '连接手台',
      'radarDisconnect': '断开手台',
      'radarPush': '推送到手台',
      'radarStatusNeedSerial': '请先点「连接手台」（正常开机界面，不要进 BOOT）',
      'radarStatusPushed': '已推送到手台：{call}',
      'radarStatusPushFail': '推送到手台失败，请确认已连接且固件支持飞机雷达',
      'radarStatusConnected': '手台已连接，点选飞机即可推送',

      // APRS map
      'aprsStatusIdle': '进入本页后将请求定位并扫描附近 APRS 台站',
      'aprsStatusLocating': '正在获取位置…',
      'aprsStatusFetching': '正在查询 aprs.fi…',
      'aprsStatusOk': '扫描中 · 发现 {n} 个台站',
      'aprsStatusEmpty': '附近暂无 APRS 台站，可输入呼号查询',
      'aprsStatusEmptySearch': '未找到该呼号的位置',
      'aprsStatusError': '获取 APRS 数据失败，将自动重试',
      'aprsStatusNeedKey': '请先填写并保存 aprs.fi API 密钥后再查询',
      'aprsStatusRateLimited': '接口限流，稍后自动重试',
      'aprsStatusPaused': '已暂停刷新',
      'aprsStatusGeoDenied': '需要允许位置权限才能按距离显示附近台站',
      'aprsStatusNoGeo': '当前浏览器不支持定位，可仍用呼号查询',
      'aprsRefresh': '刷新',
      'aprsPause': '暂停',
      'aprsResume': '继续',
      'aprsCount': '台站：{n}',
      'aprsCountZero': '台站：0',
      'aprsUpdated': '上次刷新：{time}',
      'aprsUpdatedNever': '上次刷新：—',
      'aprsDetailTitle': '台站信息',
      'aprsDetailEmpty': '点击地图上的目标查看详情',
      'aprsCallsign': '呼号(CALL)',
      'aprsType': '类型',
      'aprsComment': '注释',
      'aprsSpeed': '速度(SPD)',
      'aprsCourse': '航向(CSE)',
      'aprsAltitude': '高度(ALT)',
      'aprsDistance': '距离(DIST)',
      'aprsBearing': '方位(BRG)',
      'aprsHeard': '最后出现',
      'aprsPublished': '发布时间(DATE)',
      'aprsPath': '路径',
      'aprsTypeStation': '台站',
      'aprsTypeObject': '对象',
      'aprsTypeItem': '物品',
      ...
      'aprsTypeAis': 'AIS',
      'aprsHeardJustNow': '刚刚',
      'aprsHeardMinutes': '{n} 分钟前',
      'aprsHeardHours': '{n} 小时前',
      'aprsHeardDays': '{n} 天前',
      'aprsFootnote': '数据来源：<a href="https://aprs.fi/" target="_blank" rel="noopener noreferrer">aprs.fi</a>。',
      'aprsHowto': '① 手台正常开机 → ② 点「连接手台」→ ③ 点选台站（或点「推送到手台」）→ 机身快捷键打开 APRS 页',
      'aprsConnect': '连接手台',
      'aprsDisconnect': '断开手台',
      'aprsPush': '推送到手台',
      'aprsSearchBtn': '查询',
      'aprsSearchPlaceholder': '查询呼号，多个用逗号分隔',
      'aprsMyLocation': '重置定位',
      'aprsApiKey': 'aprs.fi 密钥',
      'aprsApiKeyHint': '如需呼号查询，请先在 <a href="https://aprs.fi/page/api" target="_blank" rel="noopener noreferrer">aprs.fi</a> 注册账号并申请 API key。',
      'aprsApiKeyPlaceholder': '在 aprs.fi 账户设置中申请',
      'aprsApiKeySave': '保存',
      'aprsStatusKeySaved': '密钥已保存在本机浏览器',
      'aprsStatusKeyCleared': '已清除本机密钥',
      'aprsStatusNeedSerial': '请先点「连接手台」（正常开机界面，不要进 BOOT）',
      'aprsStatusPushed': '已推送到手台：{call}',
      'aprsStatusAutoPushed': '自动推送：{call}',
      'aprsStatusPushFail': '推送到手台失败，请确认已连接且固件支持 APRS 地图',
      'aprsStatusConnected': '手台已连接，点选台站即可推送',
    ...
    'logWritefreqReadSuccess': '表格已清空后，已从设备填入 {count} 条（已跳过未使用槽，以及不符合完整校验的槽：RX 范围、有效功率、属性 band 与频率一致、亚音可解析）；已扫描 {scanned} 槽',
      'logChannelNameTruncate': '信道名截断提示（UTF-8，最长 15 字节）：\n{warn}',
    ...
    'visitorTodaySuffix': '人',
      ...
      'freqNamePlaceholder': '英文/中文，最长 15 字节',
      ...
      'logoSectionTitle': '开机图片',
      'bootSoundSectionTitle': '开机音效',
      'bootSoundDesc': '选择 MP3 / WAV 等音频后，网页会自动转为机内 8 kHz 单声道 PCM，并截断到最长约 5 秒。未上传或清除后，开机仍播放默认两声蜂鸣。可先试听再写入。',
      'bootSoundHint': '提示：写入的是转换后的短 PCM，不是原始 MP3；音质受 8 kHz 限制。仅 Default / Logo 开机画面会播放开机音。',
      'selectAudio': '选择音频',
      'previewBootSound': '试听',
      'stopBootSoundPreview': '停止',
      'uploadBootSound': '写入开机音',
      'clearBootSound': '清除开机音',
      'downloadBootSound': '下载 boot_sound.wav',
      'bootSoundReady': '已转换：约 {sec} 秒（{bytes} 字节 PCM）。超过部分已自动截断。可试听或下载。',
      'bootSoundTruncated': '原时长约 {orig} 秒，已截断为约 {sec} 秒。',
      'bootSoundNeedConvert': '请先选择音频并等待转换完成',
      'logUploadingBootSound': '正在写入开机音效...',
      'logErasingBootSound': '正在擦除开机音 Flash 区...',
      'logBootSoundUploadSuccess': '开机音写入成功！重启后 Default/Logo 将播放自定义音效',
      'logClearingBootSound': '正在清除开机音...',
      'logBootSoundCleared': '已清除开机音，开机将恢复默认蜂鸣',
      'logBootSoundConvertFail': '音频转换失败: {msg}',
      'logBootSoundPreviewFail': '试听失败: {msg}',
      ...
      'otherOperations': '备份校准、校验校准、恢复校准、写频、基础信息、开机图片、开机音效',
      ...
      // Coffee modal
      'coffeeTitle': '☕ 请作者喝杯咖啡',
      'coffeeText1': '感谢您使用小甜水（Syrup）固件！维护网站与固件需要时间和精力。',
    ...
    en: {
      ...
      'loadingChicken': 'Syrup is loading...',
      'loadingProgress': '0%',
      ...
      'douyin': 'Douyin',
      'douyinName': '小闫连不上',
      'douyinChipTitle': 'Douyin · 小闫连不上',
      'bili': 'Bilibili',
      'biliName': "Little Yan Can't Connect",
      'biliChipTitle': "Bilibili · Little Yan Can't Connect",
      'redbook': 'Red',
      'redbookName': '小闫同学',
      'redbookChipTitle': 'Red · 小闫同学',
      'wechatVideo': 'WeChat Video',
      'wechatVideoName': '小闫连不上',
      'wechatVideoChipTitle': 'WeChat Video · 小闫连不上',
      ...
      'mangosteenFirmwareName': 'Mangosteen',
      ...
      // Timeline sidebar
      'timelineTitle': 'Syrup Version History',
      'timelineLoading': 'Loading...',
      
      // Main header
      'mainTitle': 'Syrup Flasher',
      ...
      'step4': 'Flash Font',
      'step4Tooltip': 'Flash cn_font.bin while powered on (SPI 0x024000, 6766 chars). Re-flash when the font package updates.',
      ...
      'tabRadar': 'Aircraft Radar',
      'tabAprs': 'APRS Probe',
      'tabLogo': 'Boot Logo',
      'tabBootSound': 'Boot Sound',
      'tabMaterials': 'Materials',
      'materialsHint': 'Download, then upload from the Boot Logo / Boot Sound tabs. Images convert to 128×64 mono; audio is truncated to ~5 s PCM.',
      'materialsImagesTitle': 'Boot Images',
      'materialsSoundsTitle': 'Boot Sounds',
      ...
      // Font tab (CN font @ 0x024000)
      'fontDesc1': 'Flash Chinese font to SPI Flash (0x024000), 6766 characters.',
      'fontWarning1': '⚠️ Only needed for firmware builds that show Chinese UI/names.',
      ...
      'fontDownloadHint': '"Remote Fetch" loads the site default cn_font.bin (~200 KB, same format as Dondji).',
      ...
      'calibWriteSyrup': 'Write to Syrup Address',
      ...
      'freqNameSub': 'EN/CN, max 15 bytes UTF-8',
      'freqMHz': 'MHz',
      ...
      // Aircraft radar
      'radarStatusIdle': 'This tab will request location and scan nearby aircraft',
      'radarStatusLocating': 'Getting your location…',
      'radarStatusFetching': 'Scanning nearby aircraft…',
      'radarStatusOk': 'Scanning · {n} aircraft',
      'radarStatusEmpty': 'No ADS-B targets nearby',
      'radarStatusError': 'Failed to fetch aircraft; will retry',
      'radarStatusNeedProxy': 'Could not fetch nearby aircraft',
      'radarStatusRateLimited': 'Rate limited; will retry shortly',
      'radarStatusPaused': 'Refresh paused',
      'radarStatusGeoDenied': 'Allow location access to detect nearby aircraft',
      'radarStatusNoGeo': 'Geolocation is not supported in this browser',
      'radarLat': 'Latitude',
      'radarLon': 'Longitude',
      'radarQuery': 'Query',
      'radarRadius': 'Range (km)',
      'radarUseMyLocation': 'Reset location',
      'radarLatPlaceholder': '39.9042',
      'radarLonPlaceholder': '116.4074',
      'radarStatusBadCoords': 'Enter a valid latitude and longitude',
      'radarCoverageHint': 'Mainland China ADS-B coverage currently includes overseas, Hong Kong / Macau / Taiwan, around Guangzhou, Hefei–Nanjing, Chengdu–Mianyang, Beijing–Shijiazhuang–Handan–Tianjin and nearby, and within about 300 km of Xi’an. You can enter coordinates manually to query other areas.',
      'radarRefresh': 'Refresh',
      'radarPause': 'Pause',
      'radarResume': 'Resume',
      'radarCount': 'Aircraft: {n}',
      'radarCountZero': 'Aircraft: 0',
      'radarUpdated': 'Last update: {time}',
      'radarUpdatedNever': 'Last update: —',
      'radarDetailTitle': 'Aircraft info',
      'radarDetailEmpty': 'Tap a target on the radar for details',
      'radarCallsign': 'Callsign',
      'radarFlight': 'Flight',
      'radarAirline': 'Airline',
      'radarIcao': 'ICAO',
      'radarAltitude': 'Altitude',
      'radarSpeed': 'Ground speed',
      'radarTrack': 'Track',
      'radarDistance': 'Distance',
      'radarBearing': 'Bearing',
      'radarAirlineUnknown': 'Unknown airline',
      'radarFlightUnknown': '—',
      'radarFootnote': 'Data from <a href="https://adsb.fi/" target="_blank" rel="noopener noreferrer">adsb.fi</a> (ADS-B).',
      'radarHowto': '① Power on the radio normally → ② Click “Connect radio” → ③ Select an aircraft (or “Push to radio”) → the radio opens the aircraft page and listens in AM',
      'radarConnect': 'Connect radio',
      'radarDisconnect': 'Disconnect',
      'radarPush': 'Push to radio',
      'radarStatusNeedSerial': 'Click “Connect radio” first (normal UI, not BOOT)',
      'radarStatusPushed': 'Pushed to radio: {call}',
      'radarStatusPushFail': 'Push failed — check connection and aircraft-radar firmware',
      'radarStatusConnected': 'Radio connected — select an aircraft to push',

      // APRS map
      'aprsStatusIdle': 'This tab will request location and scan nearby APRS stations',
      'aprsStatusLocating': 'Getting your location…',
      'aprsStatusFetching': 'Querying aprs.fi…',
      'aprsStatusOk': 'Scanning · {n} stations',
      'aprsStatusEmpty': 'No APRS stations nearby — you can search by callsign',
      'aprsStatusEmptySearch': 'No position found for that callsign',
      'aprsStatusError': 'Failed to fetch APRS data; will retry',
      'aprsStatusNeedKey': 'Enter and save an aprs.fi API key first',
      'aprsStatusRateLimited': 'Rate limited; will retry shortly',
      'aprsStatusPaused': 'Refresh paused',
      'aprsStatusGeoDenied': 'Allow location access to show nearby stations by distance',
      'aprsStatusNoGeo': 'Geolocation is not supported; you can still search by callsign',
      'aprsRefresh': 'Refresh',
      'aprsPause': 'Pause',
      'aprsResume': 'Resume',
      'aprsCount': 'Stations: {n}',
      'aprsCountZero': 'Stations: 0',
      'aprsUpdated': 'Last update: {time}',
      'aprsUpdatedNever': 'Last update: —',
      'aprsDetailTitle': 'Station info',
      'aprsDetailEmpty': 'Tap a target on the map for details',
      ...
      'aprsDistance': 'Distance',
      'aprsBearing': 'Bearing',
      'aprsHeard': 'Last heard',
      'aprsPublished': 'Published',
      'aprsPath': 'Path',
      'aprsTypeStation': 'Station',
      'aprsTypeObject': 'Object',
      'aprsTypeItem': 'Item',
      'aprsTypeWx': 'Weather',
      'aprsTypeAis': 'AIS',
      'aprsHeardJustNow': 'just now',
      'aprsHeardMinutes': '{n} min ago',
      'aprsHeardHours': '{n} h ago',
      'aprsHeardDays': '{n} d ago',
      'aprsFootnote': 'Data from <a href="https://aprs.fi/" target="_blank" rel="noopener noreferrer">aprs.fi</a>.',
      'aprsHowto': '① Power on the radio normally → ② Click “Connect radio” → ③ Select a station (or “Push to radio”) → open APRS from a programmable key',
      'aprsConnect': 'Connect radio',
      'aprsDisconnect': 'Disconnect',
      'aprsPush': 'Push to radio',
      'aprsSearchBtn': 'Search',
      'aprsSearchPlaceholder': 'Search callsign, comma-separated',
      'aprsMyLocation': 'Reset location',
      'aprsApiKey': 'aprs.fi API key',
      'aprsApiKeyHint': 'Callsign lookup requires an <a href="https://aprs.fi/page/api" target="_blank" rel="noopener noreferrer">aprs.fi</a> account and API key.',
      'aprsApiKeyPlaceholder': 'Get it from your aprs.fi account',
      'aprsApiKeySave': 'Save',
      'aprsStatusKeySaved': 'API key saved in this browser',
      'aprsStatusKeyCleared': 'Saved API key cleared',
      'aprsStatusNeedSerial': 'Click “Connect radio” first (normal UI, not BOOT)',
      'aprsStatusPushed': 'Pushed to radio: {call}',
      'aprsStatusAutoPushed': 'Auto-pushed: {call}',
      'aprsStatusPushFail': 'Push failed — check connection and APRS-map firmware',
      'aprsStatusConnected': 'Radio connected — select a station to push',
    ...
    'logWritefreqReadSuccess': 'Table cleared and filled {count} channels from device (skipped unused slots and invalid slots: RX range, valid power, band matches frequency, parseable tones); scanned {scanned} slots',
      'logChannelNameTruncate': 'Channel name truncate warning (UTF-8, max 15 bytes):\n{warn}',
    ...
    'visitorTodaySuffix': 'people',
      ...
      // Writefreq table placeholders and options
      'freqNamePlaceholder': 'EN/CN, max 15 bytes UTF-8',
      ...
      'logoSectionTitle': 'Boot Logo',
      'bootSoundSectionTitle': 'Boot Sound',
      'bootSoundDesc': 'Pick MP3/WAV/etc. The page converts to on-radio 8 kHz mono PCM and truncates to ~5 s max. With no custom sound, Default/Logo boot still plays the stock dual beep. Preview before writing.',
      'bootSoundHint': 'Note: only the converted PCM is written (not the original MP3); quality is limited by 8 kHz. Boot sound plays only for Default / Logo POnMsg modes.',
      'selectAudio': 'Select audio',
      'previewBootSound': 'Preview',
      'stopBootSoundPreview': 'Stop',
      'uploadBootSound': 'Write boot sound',
      'clearBootSound': 'Clear boot sound',
      'downloadBootSound': 'Download boot_sound.wav',
      'bootSoundReady': 'Converted: ~{sec} s ({bytes} bytes PCM). Longer audio was truncated. Preview or download below.',
      'bootSoundTruncated': 'Original ~{orig} s, truncated to ~{sec} s.',
      'bootSoundNeedConvert': 'Select an audio file and wait for conversion',
      'logUploadingBootSound': 'Writing boot sound...',
      'logErasingBootSound': 'Erasing boot-sound flash region...',
      'logBootSoundUploadSuccess': 'Boot sound written. Reboot with Default/Logo to hear it.',
      'logClearingBootSound': 'Clearing boot sound...',
      'logBootSoundCleared': 'Boot sound cleared; stock beep restored',
      'logBootSoundConvertFail': 'Audio conversion failed: {msg}',
      'logBootSoundPreviewFail': 'Preview failed: {msg}',
      ...
      'otherOperations': 'Calib backup/check/restore, writefreq, basic info, boot logo, boot sound',
  ...
  // Current language
  let currentLang = 'zh';
  const LANG_STORAGE_KEY = 'syrup-web-lang';
  ...
  function applyTranslations() {
    ...
    try {
      ...
      if (typeof window.radarRefreshI18n === 'function') {
        window.radarRefreshI18n();
      }
      if (typeof window.aprsRefreshI18n === 'function') {
        window.aprsRefreshI18n();
      }
    } catch (wfErr) {}
