...
(function() {
  ...
  const translations = {
    zh: {
      ...
      'radarStatusNeedProxy': '请用 python docs/serve.py 启动本站（浏览器无法直连 ADS-B 接口）',
      ...
      'radarFlightUnknown': '—',
      'radarFootnote': '数据经本机代理拉取自 OpenSky / adsb.lol（ADS-B）。请用 python docs/serve.py 启动。',
    ...
    en: {
      ...
      'radarStatusNeedProxy': 'Start with: python docs/serve.py (browsers cannot call ADS-B APIs directly)',
      ...
      'radarFlightUnknown': '—',
      'radarFootnote': 'Data via local proxy from OpenSky / adsb.lol (ADS-B). Run: python docs/serve.py.',
