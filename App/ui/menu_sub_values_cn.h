/* UTF-8 submenu value strings when UI language is Chinese (aligned with Dondji/ccc). */
...
extern const char gSubMenu_ROGER_CN[][12]; /* 「自定义N」UTF-8 共 10 字节 + '\0' */
extern const char gSubMenu_RESET_CN[][8];
extern const char *const gSubMenu_F_LOCK_CN[];
extern const char gSubMenu_RX_TX_CN[][16];
extern const char gSubMenu_BAT_TXT_CN[][10]; /* 「百分比」UTF-8 共 9 字节 + '\0'，行宽须 ≥10 */
...
extern const char *const gSubMenu_SET_SAV_CN[];
# endif
#endif
