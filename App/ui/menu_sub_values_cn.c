/* UTF-8 Chinese strings for submenu values (Dondji/ccc-style, adapted for Syrup). */
...
const char gSubMenu_ROGER_CN[][12] = {
    ...
    "MDC",
    "Yan ID",
    "\xe8\x87\xaa\xe5\xae\x9a\xe4\xb9\x89\x31", /* 自定义1 */
    "\xe8\x87\xaa\xe5\xae\x9a\xe4\xb9\x89\x32", /* 自定义2 */
    "\xe8\x87\xaa\xe5\xae\x9a\xe4\xb9\x89\x33", /* 自定义3 */
};
...
const char *const gSubMenu_SET_SAV_CN[] = {
    "\xe5\x85\xb3",
    "LOGO",
    "LOGO+",
    "MATRIX",
...
/* Order must match gSubMenu_SIDEFUNCTIONS[] */
